...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		StateChangedActors                 func(context.Context, cid.Cid, cid.Cid) (*api.ChangedActors, error)                                  `perm:"read"`
...
func (c *FullNodeStruct) StateChangedActors(ctx context.Context, olnstate cid.Cid, newstate cid.Cid) (*api.ChangedActors, error) {
